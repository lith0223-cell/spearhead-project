              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-3">
                ...
                {routines.length === 0 ? (
                  <div className="flex flex-col items-center gap-3 py-8 text-center">
                    <p className="text-sm text-muted">등록된 루틴이 없습니다</p>
                    <Link
                      href="/routines"
                      onClick={() => setIsAddOpen(false)}
                      className="text-xs font-semibold text-accent border border-accent/40 px-4 py-2 rounded-full hover:bg-accent/10 transition-colors active:scale-95"
                    >
                      루틴 만들러 가기 →
                    </Link>
                  </div>
